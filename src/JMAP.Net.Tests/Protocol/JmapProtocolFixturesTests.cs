...
{
    [Test]
    public async Task Serialize_RequestWithResultReference_ShouldMatchFixture()
    {
    ...
    [Test]
    public async Task Deserialize_RequestFixture_ShouldExposeResultReferencePayload()
    {
    ...
    [Test]
    public async Task Serialize_SessionWithAccounts_ShouldMatchFixture()
    {
    ...
    [Test]
    public async Task Deserialize_SessionFixture_ShouldReadJmapIdDictionaryKeys()
    {
